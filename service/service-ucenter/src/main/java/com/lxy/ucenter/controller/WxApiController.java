...
import com.lxy.ucenter.utils.ConstantWxUtils;
import com.lxy.ucenter.utils.HttpClientUtils;
...
public class WxApiController {
    ...
    public String getWxQRCode() {
        ...
        //设置%s里面值
        String url = String.format(baseUrl, ConstantWxUtils.WX_OPEN_APP_ID, redirectUrl, "lxy");
    ...
    public String callback(String code, String state) {
        try {
            ...
            String jwtToken = JwtUtils.generateJwtToken(member.getId(), member.getNickname());
